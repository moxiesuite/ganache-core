...
describe("Mining", function() {
  ...
  it("should mine one block when requested, and only one transaction, when two queued transactions togvapor are larger than a single block", function() {
  ...
  it("should error via miner_start when multiple queued transactions throw runtime errors in multiple blocks", function(done) {
    ...
    // Note: The two transactions queued in this test togvapor DO exceed the block gas limit
