let ProviderEngine = require("@vapormask/web3-provider-engine");
let SubscriptionSubprovider = require('@vapormask/web3-provider-engine/subproviders/subscriptions');

let RequestFunnel = require('./subproviders/requestfunnel');
let DelayedBlockFilter = require("./subproviders/delayedblockfilter");
let GvapDefaults = require("./subproviders/gvapdefaults");
let GvapApiDouble = require('./subproviders/gvap_api_double');
...
function Provider(options) {
  ...
  let gvapApiDouble = new GvapApiDouble(options, this);

  this.engine = new ProviderEngine({
    blockTracker: new BlockTracker({ blockchain: gvapApiDouble.state.blockchain })
  });
