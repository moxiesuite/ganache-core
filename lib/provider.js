...
var SubscriptionSubprovider = require('@vapormask/web3-provider-engine/subproviders/subscriptions');

var RequestFunnel = require('./subproviders/requestfunnel');
var DelayedBlockFilter = require("./subproviders/delayedblockfilter");
var GvapDefaults = require("./subproviders/gvapdefaults");
var GvapApiDouble = require('./subproviders/gvap_api_double');
...
function Provider(options) {
  ...
  var gvapApiDouble = new GvapApiDouble(options, this);
